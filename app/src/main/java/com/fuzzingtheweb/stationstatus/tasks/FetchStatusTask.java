...
public class FetchStatusTask extends AsyncTask<Long, Void, List<Platform>> {
    ...
    public FetchStatusTask(MainActivity.StatusDetailFragment context, String station) {
        mContext = context;
        mStation = station;
    }
    ...
    protected List<Platform> doInBackground(Long... params) {
        ...
        String url = String.format(Locale.ENGLISH, "http://transportapi.com/v3/uk/tube/northern/%s/live.json?app_id=%s&api_key=%s", mStation, APP_ID, API_KEY);
